...
export function LeadForm({ lead, onSubmit, onCancel, isEdit = false }: LeadFormProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <Card className="border-slate-200">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-slate-900">{isEdit ? "Edit Lead" : "Add New Lead"}</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {/* Lead Details */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-slate-900 border-b border-slate-200 pb-2">Lead Details</h3>
